...
const agreedToTermsCheckBox = document.getElementById(
  "agree-tos"
) as HTMLInputElement;
...
agreedToTermsCheckBox.addEventListener("change", (_) => {
  updateSubmitBtn();
});

agreedToTermsCheckBox.checked = false;
